...
top-func.onmouseout = hideBut;
left-func.onmouseout = hideBut;
...
function showBut(event) {
	...
	topTab.rows[0].cells[myColumn].setAttribute("onclick","delColFunc()");
		
	leftTab.rows[myRow].cells[0].className = "del";
	leftTab.rows[myRow].cells[0].id = "delRow";
	leftTab.rows[myRow].cells[0].setAttribute("onclick","delRowFunc()");
